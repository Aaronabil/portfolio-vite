  ...
  import { SiNotion, SiBrave, SiSpotify, SiDiscord, SiRobloxstudio, SiGooglegemini } from "react-icons/si";
  ...
  const skills = [
    ...
    { name: 'Supabase', color: '#777BB4', img: 'https://raw.githubusercontent.com/devicons/devicon/master/icons/supabase/supabase-original.svg' },
    { name: 'Vercel', color: '#777BB4', img: 'https://raw.githubusercontent.com/devicons/devicon/master/icons/vercel/vercel-original.svg' },
  ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div className="absolute right-4 md:right-12 flex flex-col gap-y-16">
                  ...
                  <Circle ref={right3Ref}><SiRobloxstudio className='h-8 w-8'/></Circle>
                </div>
